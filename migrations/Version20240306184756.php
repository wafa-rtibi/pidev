 ...
 */
final class Version20240306184756 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE administrateur (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, mdp VARCHAR(255) NOT NULL, dateinscription DATETIME NOT NULL, adresse VARCHAR(255) NOT NULL, tel INT NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', is_active TINYINT(1) NOT NULL, salt VARCHAR(255) NOT NULL, google_id VARCHAR(255) DEFAULT NULL, hosted_domain VARCHAR(255) DEFAULT NULL, avatar LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, evenement_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, mdp VARCHAR(255) NOT NULL, dateinscription DATETIME NOT NULL, adresse VARCHAR(255) NOT NULL, tel INT NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', is_active TINYINT(1) NOT NULL, salt VARCHAR(255) NOT NULL, google_id VARCHAR(255) DEFAULT NULL, hosted_domain VARCHAR(255) DEFAULT NULL, avatar LONGTEXT DEFAULT NULL, INDEX IDX_1D1C63B3FD02F13 (evenement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
