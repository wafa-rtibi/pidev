 ...
 */
final class Version20240305225851 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reclamation (id INT AUTO_INCREMENT NOT NULL, reclamateur_id INT DEFAULT NULL, date_reclamation DATETIME NOT NULL, description_reclamation VARCHAR(200) NOT NULL, statut_reclamation VARCHAR(255) DEFAULT NULL, type VARCHAR(255) NOT NULL, image1 VARCHAR(255) DEFAULT NULL, image2 VARCHAR(255) DEFAULT NULL, INDEX IDX_CE6064046A3605A6 (reclamateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reponse (id INT AUTO_INCREMENT NOT NULL, reclam_reponse_id INT DEFAULT NULL, admin_id INT DEFAULT NULL, description VARCHAR(2000) NOT NULL, date_reponse DATE NOT NULL, vu TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_5FB6DEC76D585A2D (reclam_reponse_id), INDEX IDX_5FB6DEC7642B8210 (admin_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
