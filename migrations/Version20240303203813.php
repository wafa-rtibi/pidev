 ...
 */
final class Version20240303203813 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE administrateur (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, email VARCHAR(180) NOT NULL, mdp VARCHAR(255) NOT NULL, date_inscription DATETIME DEFAULT NULL, photo_profil VARCHAR(255) DEFAULT NULL, rib INT NOT NULL, adresse VARCHAR(255) NOT NULL, tel INT NOT NULL, note INT DEFAULT NULL, statut VARCHAR(255) DEFAULT NULL, role JSON NOT NULL, is_active TINYINT(1) DEFAULT NULL, salt VARCHAR(255) DEFAULT NULL, is_verified TINYINT(1) DEFAULT NULL, reset_token VARCHAR(100) DEFAULT NULL, UNIQUE INDEX UNIQ_32EB52E8E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE demande_offre (id INT AUTO_INCREMENT NOT NULL, offre_id INT DEFAULT NULL, demandeur_id INT DEFAULT NULL, opposite_id INT NOT NULL, statut VARCHAR(255) NOT NULL, date_creation DATETIME NOT NULL, message VARCHAR(255) DEFAULT NULL, INDEX IDX_595805464CC8505A (offre_id), INDEX IDX_5958054695A6EE59 (demandeur_id), UNIQUE INDEX UNIQ_59580546CC5BEE70 (opposite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE messages (id INT AUTO_INCREMENT NOT NULL, sender_id INT NOT NULL, recepient_id INT NOT NULL, message VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', is_read TINYINT(1) NOT NULL, INDEX IDX_DB021E96F624B39D (sender_id), INDEX IDX_DB021E96F1B7C6C (recepient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE offre (id INT AUTO_INCREMENT NOT NULL, offreur_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, categorie VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, etat VARCHAR(255) NOT NULL, date_publication DATETIME NOT NULL, image1 VARCHAR(255) DEFAULT NULL, image2 VARCHAR(255) DEFAULT NULL, image3 VARCHAR(255) DEFAULT NULL, vues INT NOT NULL, INDEX IDX_AF86866FB05122F8 (offreur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reponse (id INT AUTO_INCREMENT NOT NULL, description VARCHAR(255) NOT NULL, date_reponse DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, evenement_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, email VARCHAR(180) NOT NULL, mdp VARCHAR(255) NOT NULL, date_inscription DATETIME DEFAULT NULL, photo_profil VARCHAR(255) DEFAULT NULL, rib INT NOT NULL, adresse VARCHAR(255) NOT NULL, tel INT NOT NULL, note INT DEFAULT NULL, statut VARCHAR(255) DEFAULT NULL, role JSON NOT NULL, is_active TINYINT(1) DEFAULT NULL, salt VARCHAR(255) DEFAULT NULL, is_verified TINYINT(1) DEFAULT NULL, reset_token VARCHAR(100) DEFAULT NULL, UNIQUE INDEX UNIQ_1D1C63B3E7927C74 (email), INDEX IDX_1D1C63B3FD02F13 (evenement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE demande_offre ADD CONSTRAINT FK_59580546CC5BEE70 FOREIGN KEY (opposite_id) REFERENCES offre (id)');
        ...
        $this->addSql('ALTER TABLE messages ADD CONSTRAINT FK_DB021E96F1B7C6C FOREIGN KEY (recepient_id) REFERENCES utilisateur (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demande_offre DROP FOREIGN KEY FK_59580546CC5BEE70');
        ...
        $this->addSql('ALTER TABLE offre_utilisateur DROP FOREIGN KEY FK_5635E9934CC8505A');
        $this->addSql('ALTER TABLE offre_utilisateur DROP FOREIGN KEY FK_5635E993FB88E14F');
